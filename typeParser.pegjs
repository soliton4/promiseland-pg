...
Start
  = __ id:IdentifierNames __ "(" __ len:NumericLiteral __ ")" __ {
    return {
      name: id,
      length: len.value
    };
  }
  / __ id:IdentifierNames __ {
    return { name: id };
  }
  

/*
  parsing a typename doesnt have to be as complicated as implemented in here
  the complexity results from copying and pasting code from the promiseland parser
*/
...
IdentifierNamePart
  = __ rest:IdentifierName {
      return rest;
    }
    
IdentifierNames
  = first:IdentifierName rest:IdentifierNamePart* {
      var res = first.name;
      var i = 0;
