...
return (function() {
  ...
  function parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$c97 = "u",
        peg$c98 = { type: "literal", value: "u", description: "\"u\"" },
    ...
    function peg$parseIdentifierNamePart() {
      var s0, s1, s2;
    ...
    function peg$parseIdentifierNames() {
      ...
      if (s1 !== peg$FAILED) {
        s2 = [];
        s3 = peg$parseIdentifierNamePart();
        while (s3 !== peg$FAILED) {
          s2.push(s3);
          s3 = peg$parseIdentifierNamePart();
        }
